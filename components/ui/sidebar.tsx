    ...
    if (collapsible === "none") {
      return (
        <div
          ...
          className={cn(
            "flex h-full w-[--sidebar-width] flex-col bg-card text-card-foreground border border-secondary",
            className
          )}
          ref={ref}
          {...props}
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 bg-card flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
